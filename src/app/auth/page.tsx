...
function buildRedirectUrl() {
  const baseHost = process.env.NEXT_PUBLIC_APP_URL || 'https://pwa-no-actions-02231646.vercel.app';
      ...
      <div className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-6 py-12">
        <header className="space-y-2">
          ...
          <p className="text-slate-400">
            Magic link sign-in and sign-out flow powered by Supabase in Termux.
          </p>
        </header>
